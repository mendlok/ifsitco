                    ...
                    <div class="col-xs-4">
                     ...
                     <div class="col-xs-8">
                      ...
                      <div class="tab-content">
                        ...
                        <li class=""><a href="{{url('/mypackages/myalerts')}}"  aria-expanded="false">  Alertados y pendientes de recibo en Miami</a>
                        </li>

                        <li class=""><a href="{{url('/mypackages/holdInMiami')}}">Retenidos en Miami</a>
                        </li>
                           <li class=""><a href="{{url('/mypackages/inTransit')}}">En tránsito:Miami - Destino Final</a>
                        </li>
                           <li class=""><a href="{{url('/mypackages/delivered')}}">Entregados</a>
                        </li>
                           <li class=""><a href="{{url('/mypackages/holdByInvoice')}}"> Retenidos por falta de Factura Comercial</a>
                        </li>
